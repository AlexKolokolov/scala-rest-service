...
import org.kolokolov.model.{Car, Entity}
...
class RestServiceTest extends AsyncFunSuite
  ...
  private val firstEntity = Car("Mercury","aaa",1)
  private val secondEntity = Car("Venus","aaa",2)

  private val stubEntityService = stub[CarService]
